define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function() {
            ...
            Table.api.init({
                extend: {
                    index_url: 'spotmanage/service/index' + location.search,
                    add_url: 'spotmanage/service/add',
                    edit_url: 'spotmanage/service/edit',
                    del_url: 'spotmanage/service/del',
                    multi_url: 'spotmanage/service/multi',
                    import_url: 'spotmanage/service/import',
                    table: 'service',
                }
            });

define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function() {
            ...
            Table.api.init({
                extend: {
                    index_url: 'spotmanage/parking/index' + location.search,
                    add_url: 'spotmanage/parking/add',
                    edit_url: 'spotmanage/parking/edit',
                    del_url: 'spotmanage/parking/del',
                    multi_url: 'spotmanage/parking/multi',
                    import_url: 'spotmanage/parking/import',
                    table: 'parking',
                }
            });

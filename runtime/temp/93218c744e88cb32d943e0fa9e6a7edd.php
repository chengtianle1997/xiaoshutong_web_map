<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:78:"/www/wwwroot/zhjq.g2world.cn/public/../application/index/view/index/index.html";i:1614564581;}*/ ?>
<!DOCTYPE html>
<html>
...
<body>
    ...
    <!-- ===================智能助手======================= -->
    <div class="smart-btn" id="getTalk"></div>
    <!-- ===================头部弹窗======================= -->
    <!-- 播放器弹框 -->
...
<script src="/assets/libs/crypto-js/crypto-js.js"></script>
<script type="module" src="/assets/js/web/xfvoice/transcode.worker.js"></script>
<script type="module" src="/assets/js/web/xfvoice/listen.js"></script>
<script type="module" src="/assets/js/web/smart-assist.js"></script>
</html>
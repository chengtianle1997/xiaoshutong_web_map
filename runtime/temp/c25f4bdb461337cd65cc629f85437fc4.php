        ...
        <div class="col-xs-12 col-sm-8">
            <div class="input-group">
                ...
                <div class="input-group-addon no-border no-padding">
                    <span><button type="button" id="faupload-backgroudimage" class="btn btn-danger faupload" data-input-id="c-backgroudimage" data-mimetype="image/gif,image/jpeg,image/png,image/jpg,image/bmp" data-multiple="false" data-preview-id="p-backgroudimage" data-upload-success="onSuccess" data-upload-error="onError"><i class="fa fa-upload"></i> <?php echo __('Upload'); ?></button></span>

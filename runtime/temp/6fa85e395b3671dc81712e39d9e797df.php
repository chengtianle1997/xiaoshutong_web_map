<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:101:"/home/wwwroot/map.weihangnetwork.com/public/../application/admin/view/spotmanage/visitroute/edit.html";i:1609904377;s:79:"/home/wwwroot/map.weihangnetwork.com/application/admin/view/layout/default.html";i:1608223426;s:76:"/home/wwwroot/map.weihangnetwork.com/application/admin/view/common/meta.html";i:1608223426;s:78:"/home/wwwroot/map.weihangnetwork.com/application/admin/view/common/script.html";i:1608223426;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-routeame" data-rule="required" class="form-control" name="row[routeame]" type="text" value="<?php echo htmlentities($row['routeame']); ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Linelength'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-linelength" data-rule="required" class="form-control" name="row[linelength]" type="text" value="<?php echo htmlentities($row['linelength']); ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Burncalories'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-burncalories" data-rule="required" class="form-control" name="row[burncalories]" type="text" value="<?php echo htmlentities($row['burncalories']); ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Nearbyspot'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-nearbyspot" data-rule="required" class="form-control" name="row[nearbyspot]" type="text" value="<?php echo htmlentities($row['nearbyspot']); ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Allspot'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-allspot" data-rule="required" class="form-control" name="row[allspot]" type="text" value="<?php echo htmlentities($row['allspot']); ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Expecthours'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-expecthours" data-rule="required" class="form-control" name="row[expecthours]" type="text" value="<?php echo htmlentities($row['expecthours']); ?>">
        </div>
    </div>
    <div class="form-group">

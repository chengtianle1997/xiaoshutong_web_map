<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:98:"/home/wwwroot/map.weihangnetwork.com/public/../application/admin/view/spotmanage/spottype/add.html";i:1608784989;s:79:"/home/wwwroot/map.weihangnetwork.com/application/admin/view/layout/default.html";i:1608223426;s:76:"/home/wwwroot/map.weihangnetwork.com/application/admin/view/common/meta.html";i:1608223426;s:78:"/home/wwwroot/map.weihangnetwork.com/application/admin/view/common/script.html";i:1608223426;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-typename" data-rule="required" class="form-control" autocomplete="off" name="row[typename]" type="text">
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <div class="input-group">
                <input id="c-typeimage" data-rule="required" class="form-control" size="50" name="row[typeimage]" type="text">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <div class="input-group">
                <input id="c-typeselectedimage" data-rule="required" class="form-control" size="50" name="row[typeselectedimage]" type="text">
                <div class="input-group-addon no-border no-padding">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <div class="input-group">
                <input id="c-spotimage" data-rule="required" class="form-control" size="50" name="row[spotimage]" type="text">
                <div class="input-group-addon no-border no-padding">

<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:85:"/home/wwwroot/zhjq.g2world.cn/public/../application/common/view/tpl/dispatch_jump.tpl";i:1608223426;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="system-message <?php echo $codeText; ?>">
    <div class="image">
        <img src="/public/assets/img/<?php echo $codeText; ?>.svg" alt="" width="120" />
    </div>
    <h1><?php echo $msg; ?></h1>
    <?php if($url): ?>
        <p class="jump">

<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:100:"/Users/chenkun/Work/git/tour-guide/src/map/public/../application/admin/view/spotmanage/spot/add.html";i:1609263805;s:85:"/Users/chenkun/Work/git/tour-guide/src/map/application/admin/view/layout/default.html";i:1608223426;s:82:"/Users/chenkun/Work/git/tour-guide/src/map/application/admin/view/common/meta.html";i:1608223426;s:84:"/Users/chenkun/Work/git/tour-guide/src/map/application/admin/view/common/script.html";i:1608223426;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-spotare_id" data-rule="required" disabled data-source="spotmanage/spotare/selectpage" data-params='{"custom[id]":<?php echo \think\Session::get('spotarea_id'); ?>}' data-field="areaname" class="form-control selectpage" name="row[spotare_id]" type="text" value="<?php echo \think\Session::get('spotarea_id'); ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Spottype_id'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-spottype_id" data-rule="required" disabled data-source="spotmanage/spottype/selectpage" data-field="typename" class="form-control selectpage" name="row[spottype_id]" type="text" value="1">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Spotname'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-spotname" data-rule="required" class="form-control" autocomplete="off" name="row[spotname]" type="text">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Lnglat'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-lnglat" data-rule="required" class="form-control" autocomplete="off" name="row[lnglat]" type="text">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-lat" data-rule="required" class="form-control" step="1" name="row[voiceradius]" type="number">
        </div>
    </div>
    ...
    <!-- <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-lng" data-rule="required" class="form-control" step="0.000000000000001" name="row[lng]" type="number">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Lat'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-lat" data-rule="required" class="form-control" step="0.000000000000001" name="row[lat]" type="number">
        </div>
    </div> -->
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <div class="input-group">
                <input id="c-backgroudimage" class="form-control" size="50" name="row[backgroudimage]" type="text">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <textarea id="c-spotintroduce" class="form-control " rows="5" name="row[spotintroduce]" cols="50"></textarea>
        </div>
    </div>
    <!-- <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Navigation'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-navigation" class="form-control" name="row[navigation]" type="text">
        </div>
    </div> -->
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <div class="input-group">
                <input id="c-voicefile" class="form-control" size="50" name="row[voicefile]" type="text">
                <div class="input-group-addon no-border no-padding">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            ...
            <div class="radio">
                ...
                <label for="row[statusdata]-<?php echo $key; ?>"><input id="row[statusdata]-<?php echo $key; ?>" name="row[statusdata]" type="radio" value="<?php echo $key; ?>" <?php if(in_array(($key), explode(',',"normal"))): ?>checked<?php endif; ?> /> <?php echo $vo; ?></label> <?php endforeach; endif; else: echo "" ;endif; ?>
            </div>
